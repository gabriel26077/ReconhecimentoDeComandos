...
audio_dirs = ['dataset/audios/', 'dataset_extra/']
...
# Treinar um modelo (por exemplo, SVM)
model = SVC()
...
os.makedirs('fscalers', exist_ok=True)
...
print("Modelo SVM e escalador exportados com sucesso!")
